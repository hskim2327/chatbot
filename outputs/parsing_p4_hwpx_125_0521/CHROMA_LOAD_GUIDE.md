...
```text
outputs/parsing_p4_hwpx_125_0521/chunks_v2_125.jsonl
```

비교 실험이 필요하면 v1 baseline도 사용할 수 있습니다.

```text
outputs/parsing_p4_hwpx_125_0521/chunks_v1_125.jsonl
```
...
path = Path("outputs/parsing_p4_hwpx_125_0521/chunks_v2_125.jsonl")
chunk_types = Counter()
fact_types = Counter()
