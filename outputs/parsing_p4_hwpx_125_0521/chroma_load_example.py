...
Colab 권장 실행 예시:
    !python outputs/parsing_p4_hwpx_125_0521/chroma_load_example.py \
        --chunks outputs/parsing_p4_hwpx_125_0521/chunks_v2_125.jsonl \
        --chroma-path /content/chroma_parsing_p4_hwpx_125_0521 \
        --device cuda \
        --force-rebuild

GCP VM 권장 실행 예시:
    python outputs/parsing_p4_hwpx_125_0521/chroma_load_example.py \
        --chunks /path/to/outputs/parsing_p4_hwpx_125_0521/chunks_v2_125.jsonl \
        --chroma-path /mnt/disks/local-ssd/chroma_parsing_p4_hwpx_125_0521 \
        --device cuda \
        --force-rebuild
