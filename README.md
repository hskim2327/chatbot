...
[최종 보고서 바로가기](docs/ysy_data_generation_final_report.md)
...
현재 최종 공유 기준은 [`690_new`](https://drive.google.com/drive/folders/1Tl8YirT6YYkk0a5z2L627I88NG8gII7O?usp=sharing)입니다. (구글 드라이브)
...
| v2 최고 hybrid | dense + BM25 RRF + reranker | 0.990 | 0.959 | 0.9578 | 0.9825 | 0.9792 | P95 3602.69ms |
...
| 모델 | JSON 정상률 | 빈 답변 | 숫자 근거성 | 평균 생성 시간 | Faithfulness | Context Recall | Context Precision | Answer Relevancy |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
