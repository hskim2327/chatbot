...
PHASE3_EXPERIMENT_LOG = "phase3_domain_experiments.csv"
DEFAULT_DOMAIN_GOLD_PATH = "eval/evaluation/data/rfp_domain_gold_sample.jsonl"
PHASE4_EXPERIMENT_LOG = "phase4_llm_judge_experiments.csv"
